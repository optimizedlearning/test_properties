...
def main():
    ...
    # for i in range(10,30):
    #     data_files.append("/projectnb/aclab/datasets/pile/raw_data/train/"+str(i)+".jsonl")
    # raw_datasets_train = load_dataset('json', data_files = data_files)
    # raw_datasets_val = load_dataset('json', data_files = ["/projectnb/aclab/datasets/pile/raw_data/val.jsonl"])
