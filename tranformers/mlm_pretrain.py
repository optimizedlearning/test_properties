...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to save torch checkpoint",
        required=False,
    )
    ####
    parser.add_argument(
...
def main():
    ...
    if args.dataset_name is not None:
        ...
        raw_datasets = load_dataset(args.dataset_name,args.dataset_config_name, data_dir = args.path, streaming = args.streaming)
        ...
        wandb.log(
                {
                    ...
                    "epoch": epoch,
                    "step": completed_steps,
                    "convexity_gap_end": convexity_gap/iteration,
                    "smoothness_end": L,
                    "linear/loss_gap_end": num/denom
                },
                step=completed_steps,
            )
        ####
